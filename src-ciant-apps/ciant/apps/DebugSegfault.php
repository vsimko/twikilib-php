...
/**
 * @runnable
 * TODO: segmentation fault if parent topic of GlobalGateway is GlobalGateway
 * @author Viliam Simko
 */
class DebugSegfault {
	...
	final public function run() {
		...
		try {
			...
			assert($e instanceof ParentProjectNotFoundException || $e instanceof TopicNotFoundException);
